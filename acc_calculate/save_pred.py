...
# time:2021/7/7
# 从excel 找出 pred  图像，要求   score 4个指标 相加大于3.4
...
if __name__ == "__main__":
    ...
    # read_dir = r"C:\Users\brighten\Desktop\0324_两阶段_0306模型,只监督条带区域，带8张图\casia_test\pred_train\result3\\"

    # coverage   26张
    # df = pd.read_excel(r"C:\Users\brighten\Desktop\save\coverage.xlsx")
    # save_dir = r"C:\Users\brighten\Desktop\act_well\result_coverage"
    # read_dir = r"C:\Users\brighten\Desktop\0324_两阶段_0306模型,只监督条带区域，带8张图\coverage_test\pred_train\result3\\"

    # columbia  156张
    df = pd.read_excel(r"C:\Users\brighten\Desktop\save\calumbia.xlsx")
    save_dir = r"C:\Users\brighten\Desktop\act_well\result_columia"
    read_dir=r"C:\Users\brighten\Desktop\0324_两阶段_0306模型,只监督条带区域，带8张图\columb\result4\\"  # 读取路径

    # 修改上方路径
    read_src(df, save_dir, score=3.4)
